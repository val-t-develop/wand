...
const map<BinaryOperatorNode::BinaryOperatorKind, string> BinaryOperatorNode::operatorKinds = {
    ...
    {BinaryOperatorNode::BinaryOperatorKind::INSTANCEOF, "instanceof"},
...
BinaryOperatorNode::BinaryOperatorNode(shared_ptr<ExpressionNode> _left, shared_ptr<ExpressionNode> _right,
                                       BinaryOperatorKind _op, shared_ptr<Node> _parent)
    : ExpressionNode(_parent), left(_left), right(_right), op(_op) {}
