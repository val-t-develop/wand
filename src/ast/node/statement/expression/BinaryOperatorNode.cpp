...
const map<string, BinaryOperatorNode::BinaryOperatorKind> BinaryOperatorNode::operatorKinds = {
...
BinaryOperatorNode::BinaryOperatorNode(shared_ptr<ExpressionNode> _left, shared_ptr<ExpressionNode> _right,
    ...
    : ExpressionNode(_parent, NodeKind::BINARY_OPERATOR_NODE), left(_left), right(_right), op(_op) {}
